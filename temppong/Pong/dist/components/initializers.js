...
export function canvasInitializer(canvas) {
    canvas.width = CON.SCREEN_WIDTH;
    canvas.height = CON.SCREEN_HEIGHT;
    canvas.style.backgroundColor = "black";
}
export function paddleInitializer(side) {
...
export function wallInitializer(side, type) {
    if (type != 0 && type != 1) {
...
export function lineInitializer(name) {
...
export function keyListenerInitializer(game) {
