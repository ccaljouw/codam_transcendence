...
import { settleScore, endGame, updateMessageField } from "../utils/utils.js";
import { wallInitializer, paddleInitializer, ballInitializer, keyListenerInitializer, messageFieldInitializer, lineInitializer, canvasInitializer } from "./initializers.js";
export class Game {
    gameState = CON.GameState.ready;
    messageField = null;
    ball = null;
    players = [];
