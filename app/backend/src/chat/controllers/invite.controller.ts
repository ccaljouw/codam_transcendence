...
export class InviteController {
  ...
  @ApiOperation({
    summary:
      'Returns all invites with specified state currently in the database',
  })
  @ApiOkResponse({ type: [UpdateInviteDto] })
  @ApiNotFoundResponse({
    description: 'No invites with #${state} in the database',
  })
  findInvitesWithState(
    @Param('state') inviteState: string,
  ...
  @ApiOperation({
    summary:
      'Returns all invites with specified type currently in the database',
  })
  @ApiOkResponse({ type: [UpdateInviteDto] })
  @ApiNotFoundResponse({
    description: 'No invites with #${state} in the database',
  ...
  @ApiOperation({
    summary:
      'Returns all invites with specified senderId and state currently in the database',
  })
  @ApiOkResponse({ type: [UpdateInviteDto] })
  @ApiNotFoundResponse({
    description: 'No invites in the database for #${senderId} with #${state}',
  })
  findInvitesWithStateForSender(
    ...
    return this.inviteService.findInvitesWithStateForSender(
      senderId,
      inviteState as InviteStatus,
    );
  }
  ...
  @ApiOperation({
    summary:
      'Returns all invites for specified senderId and type currently in the database',
  })
  @ApiOkResponse({ type: [UpdateInviteDto] })
  @ApiNotFoundResponse({
    description: 'No invites in the database for #${senderId} with #${type}',
  })
  findInvitesWithTypeForSender(
    @Param('senderId', ParseIntPipe) senderId: number,
    ...
    return this.inviteService.findInvitesWithTypeForSender(
      senderId,
      type as InviteType,
    );
  }
  ...
  @ApiOperation({
    summary:
      'Returns all invites with specified recipientId and state currently in the database',
  })
  @ApiOkResponse({ type: [UpdateInviteDto] })
  @ApiNotFoundResponse({
    description:
      'No invites in the database for #${recipientId} with #${state}',
  })
  findInvitesWithStateForRecipient(
    ...
    return this.inviteService.findInvitesWithStateForRecipient(
      recipientId,
      inviteState as InviteStatus,
    );
  }
  ...
  @ApiOperation({
    summary:
      'Returns all invites for specified recipientId and type currently in the database',
  })
  @ApiOkResponse({ type: [UpdateInviteDto] })
  @ApiNotFoundResponse({
    description: 'No invites in the database for #${recipientId} with #${type}',
  })
  findInvitesWithTypeForRecipient(
    @Param('recipientId', ParseIntPipe) recipientId: number,
    @Param('type') type: string,
  ): Promise<UpdateInviteDto[]> {
    if (!(type in InviteType)) {
    ...
    return this.inviteService.findInvitesWithTypeForRecipient(
      recipientId,
      type as InviteType,
    );
  }
  ...
  respondToFriendInvite(
    ...
    return this.inviteService.respondToFriendRequest(
      id,
